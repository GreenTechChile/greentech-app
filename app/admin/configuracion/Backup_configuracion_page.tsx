      ...
      <main style={{ flex: 1, padding: 24, overflowY: 'auto' as const, background: '#fff' }}>
        ...
        {tabActiva === 'corporacion' && (
          <div style={{ maxWidth: 680 }}>
            <h3 style={{ fontSize: 14, fontWeight: 600, marginBottom: 16 }}>Datos de la corporación</h3>
            <div style={s.field}>
              <label style={s.label}>Nombre legal</label>
              <input style={s.input} value={corp.nombre} onChange={e => setCorp(p => ({ ...p, nombre: e.target.value }))} />
            </div>
            <div style={s.grid2}>
              <div style={s.field}>
                <label style={s.label}>RUT corporación</label>
                <input
                  style={{ ...s.input, borderColor: rutError ? '#E24B4A' : corp.rut && validarRut(corp.rut) ? '#97C459' : '#d1d5db' }}
                  value={corp.rut}
              ...
              <div style={s.field}>
                ...
                <input style={s.input} value={corp.inscripcion} onChange={e => setCorp(p => ({ ...p, inscripcion: e.target.value }))} />
              </div>
            </div>
            <div style={s.field}>
              <label style={s.label}>Domicilio legal</label>
              <input style={s.input} value={corp.domicilio} onChange={e => setCorp(p => ({ ...p, domicilio: e.target.value }))} />
            </div>
            <div style={s.grid2}>
              <div style={s.field}>
                <label style={s.label}>Correo corporativo</label>
                <input style={s.input} value={corp.email} onChange={e => setCorp(p => ({ ...p, email: e.target.value }))} />
              </div>
              <div style={s.field}>
                <label style={s.label}>Teléfono</label>
                <input style={s.input} value={corp.telefono} onChange={e => setCorp(p => ({ ...p, telefono: e.target.value }))} />
              </div>
            </div>
            ...
            <div style={s.grid2}>
              <div style={s.field}>
                ...
                <input style={s.input} value={corp.presidente} onChange={e => setCorp(p => ({ ...p, presidente: e.target.value }))} />
              </div>
              <div style={s.field}>
                <label style={s.label}>Secretario</label>
                <input style={s.input} value={corp.secretario} onChange={e => setCorp(p => ({ ...p, secretario: e.target.value }))} />
              </div>
              <div style={s.field}>
                <label style={s.label}>Tesorero</label>
                <input style={s.input} value={corp.tesorero} onChange={e => setCorp(p => ({ ...p, tesorero: e.target.value }))} />
              </div>
              <div style={s.field}>
                <label style={s.label}>Vigencia directiva</label>
                <input style={s.input} value={corp.vigencia} onChange={e => setCorp(p => ({ ...p, vigencia: e.target.value }))} />
              </div>
            </div>
